...
tf.app.flags.DEFINE_string('train_dir', 'AgeGenderDeepLearning/Folds/tf/test_fold_is_0',
...
tf.app.flags.DEFINE_string('eval_dir', 'AgeGenderDeepLearning/Folds/tf/eval_test_fold_is_0',
